  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        />
        <Route
          path="/dashboard/stock-management/parent/:parentId/sub/:subId"
          element={<StockManagement />}
        />
        <Route path="/dashboard/stock-management/parent/:parentId" element={<StockManagement />} />
        <Route path="/dashboard/stock-management" element={<StockManagement />} />
